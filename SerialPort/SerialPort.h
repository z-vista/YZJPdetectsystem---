...
public:
	...
	*  @see:
	*/
	bool InitPort(UINT  portNo = 1, UINT  baud = CBR_19200, char  parity = 'N', UINT  databits = 8, UINT  stopsbits = 1, DWORD dwCommEvents = EV_RXCHAR);
